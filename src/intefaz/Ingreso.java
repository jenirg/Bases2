...
public class Ingreso extends javax.swing.JFrame {
    ...
    private void jButtonsesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonsesionActionPerformed
        ...
        boolean entrada = miCrud.accesoUsuario(usuario, pass);// comprobamos la existencia del usuario y contraseña
        ...
        if (usuario.equals("") || pass_concatenada.equals("")) {
            ...
            //if (usuario.equals(correo) && pass_concatenada.equals(pass)) {
            if (entrada==true ){                
            //verificar que la cuenta exista y sea la correcta BD
                ...
                if (boton_numero == 1) {
                    ...
                    entrega entrega = new entrega(usuario);
                    entrega.setVisible(true);
                    dispose();
                } else if (boton_numero == 3) {
                    Colaborador xx = new Colaborador(usuario);
                    xx.setVisible(true);
                    dispose();
