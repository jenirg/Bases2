...
public class PanelMail2 extends javax.swing.JFrame {
 CRUD miCrud = new CRUD();
    ...
    public PanelMail2(int aut,String correo,String contraseña, String primer_nombre, String segundo_nombre, String primer_apellido, String segundo_apellido) {
        ...
        // if (ubicaciondeform==1){
            ...
            if(codigo == multiplicacion){
                try {
                    ...
                    autorizarbackup++;
                    micrud.commit();
                    mibitacora.Guardar_Clasificación(txtdestino.getText(), mibitacora.fechaactual(), mibitacora.horaactual(),"commit" ,"usuario");
                    ...
                    micrud.rollback();
                    mibitacora.Guardar_Clasificación(txtdestino.getText(), mibitacora.fechaactual(), mibitacora.horaactual(),"rollback" ,"usuario");
